            ...
            <Tab.Panels className='bg-gray-100/20 border border-gray-300 mx-5 min-h-screen'>
                <Tab.Panel key='about'>
                    <div className='p-5'>
                            ...
                            {props.course.about || (
                                <div>
                                    <p>
                                        ...
                                        en su Entorno Virtual de Aprendizaje
                                        EVA, que la Universidad Nacional de
                                        Ingeniería pone a tu disposición en el
                                        proceso de aprendizaje con el
                                        aprovechamiento de las Tic. En el curso
                                        aprenderás… para dar cumplimientos de
                                        los objetivos…
                                        <br />
                                        <br />
                                    </p>
                                    <p className='text-orange-500'>
                                        El docente podrá modificar o agregar
                                        esta información conforme a su
                                        asignatura…
                                    </p>
                                </div>
                            )}
                        ...
                        <div className='my-3'>
                            <p>
                                En este apartado el profesor deberá agregar el
                                objetivo general y los específicos del programa
                                de asignatura {props.course.name}
                            </p>
                            <div className='mt-4'>
                ...
                <Tab.Panel key='evaluaciones'>
                    <div className='p-5'>
                        ...
                        <p className='text-gray-700 my-4'>
                            En esta parte comprobaras tus habilidades y
                            destreza, para la realización de actividades
                            evaluativas en la que se debe de planificar,
                            desarrollar, entregar y resolver las asignaciones
                            correspondientes al curso de MATEMATICA I PARA
                            COMPUTACION, para los futuros Ingenieros y
                            Arquitectos UNI.
                        </p>
                        <div>
